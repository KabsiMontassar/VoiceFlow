...
import { User, Room, Message, RoomUser, MessageType } from '@voiceflow/shared';
...
export class RoomModel extends Model<Room> implements Room {
  declare id: string;
  declare code: string;
  declare name: string;
...
export class RoomUserModel extends Model<RoomUser> implements RoomUser {
  declare id: string;
  declare roomId: string;
  declare userId: string;
